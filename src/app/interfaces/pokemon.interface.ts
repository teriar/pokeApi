...
export interface CategoriasPokemon {
    abilities:                Ability[];
...
export class Convert {
    public static toCategorias(json: string): CategoriasPokemon {
        return cast(JSON.parse(json), r("Categorias"));
    }

    public static categoriasToJson(value: CategoriasPokemon): string {
